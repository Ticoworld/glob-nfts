...
const Glob2EarnDashboard: React.FC = () => {
  ...
  const tasks: Task[] = [
    ...
    },
    {
      id: 'tweet',
      name: 'Tweet 2 Times',
      description: `Post 2 tweets this week to earn points. (${tweetCount}/2 tweets)`,
      status: tweetCount >= 2 ? 'completed' : 'pending',
      points: tweetCount,
      action: tweetCount < 2 ? scrollToTweetSubmission : undefined,
    },
    {
      id: 'discord-join',
      name: 'Join Discord',
