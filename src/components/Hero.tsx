            ...
            <div className="lg:col-span-7 lg:order-1 order-2">
              ...
              >
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl text-display mb-6 leading-tight">
                  <span className="text-gradient">GlobNFTs</span>
                  <br />
                ...
                <p className="text-lg sm:text-xl text-gray-300 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                  GlobNFTs is a chaotic, community-driven NFT collection. Make
                  posts about the project, earn points, and climb the
                  leaderboard. Join the chaos, showcase your creativity, and
                  unlock future utility as a holder!
                </p>
